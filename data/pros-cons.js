// ================================================================
//  PIXELVERSE — Đoán Ưu/Nhược — Dữ liệu mặc định
//
//  Để cập nhật nội dung:
//  1. Đăng nhập Admin trên web
//  2. Chỉnh nội dung trong Admin Settings
//  3. Nhấn EXPORT JSON → copy nội dung
//  4. Thay thế mảng bên dưới bằng nội dung đã copy
//  5. Lưu file và deploy
// ================================================================

window.PROS_CONS_DATA = [
  {
    id: 1,
    topic: "Mạng xã hội",
